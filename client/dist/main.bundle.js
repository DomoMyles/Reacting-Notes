...
(() => {
                ...
                n.exports = function (n) {
                    ...
                    return t.toString = function () {
                        ...
                        for (var u = 0; u < n.length; u++) {
                            var l = [].concat(n[u]);
                            r && i[l[0]] || (void 0 !== a && (void 0 === l[5] || (l[1] = "@layer".concat(l[5].length > 0 ? " ".concat(l[5]) : "", " {").concat(l[1], "}")), l[5] = a), e && (l[2] ? (l[1] = "@media ".concat(l[2], " {").concat(l[1], "}"), l[2] = e) : l[2] = e), o && (l[4] ? (l[1] = "@supports (".concat(l[4], ") {").concat(l[1], "}"), l[4] = o) : l[4] = "".concat(o)), t.push(l))
                        }
                    }, t
                }
            },
            ...
            61: (n, t, e) => {
                ...
                function o() {
                    ...
                    var t = {},
                        e = Object.prototype,
                        a = e.hasOwnProperty,
                        i = Object.defineProperty || function (n, t, e) {
                            n[t] = e.value
                        },
                    ...
                    function k(n, t) {
                        function e(o, i, c, s) {
                            ...
                            if ("throw" !== u.type) {
                                var l = u.arg,
                                    f = l.value;
                                return f && "object" == r(f) && a.call(f, "__await") ? t.resolve(f.__await).then((function (n) {
                                    e("next", n, c, s)
                                }), (function (n) {
                                    e("throw", n, c, s)
                                })) : t.resolve(f).then((function (n) {
                                    l.value = n, c(l)
                                }), (function (n) {
                    ...
                    function E(n, t, e) {
                        ...
                        return function (o, a) {
                            ...
                            for (e.method = o, e.arg = a;;) {
                                ...
                                var s = p(n, t, e);
                                if ("normal" === s.type) {
                                    if (r = e.done ? "completed" : "suspendedYield", s.arg === h) continue;
                                    return {
                                        value: s.arg,
                                        done: e.done
                                    }
                    ...
                    function S(n, t) {
                        ...
                        if (void 0 === e) {
                            if (t.delegate = null, "throw" === t.method) {
                                if (n.iterator.return && (t.method = "return", t.arg = void 0, S(n, t), "throw" === t.method)) return h;
                                t.method = "throw", t.arg = new TypeError("The iterator does not provide a 'throw' method")
                            }
                            return h
                        }
                        var r = p(e, n.iterator, t.arg);
                        if ("throw" === r.type) return t.method = "throw", t.arg = r.arg, t.delegate = null, h;
                        var o = r.arg;
                        return o ? o.done ? (t[n.resultName] = o.value, t.next = n.nextLoc, "return" !== t.method && (t.method = "next", t.arg = void 0), t.delegate = null, h) : o : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, h)
                    }
                        ...
                        if (n) {
                            ...
                            if (!isNaN(n.length)) {
                                var e = -1,
                                    r = function t() {
                                        for (; ++e < n.length;)
                                            if (a.call(n, e)) return t.value = n[e], t.done = !1, t;
                    ...
                    return g.prototype = m, i(x, "constructor", {
                        value: m,
                        configurable: !0
                    }), i(m, "constructor", {
                        value: g,
                        configurable: !0
                    }), g.displayName = f(m, l, "GeneratorFunction"), t.isGeneratorFunction = function (n) {
                        var t = "function" == typeof n && n.constructor;
                        return !!t && (t === g || "GeneratorFunction" === (t.displayName || t.name))
                    }, t.mark = function (n) {
                        return Object.setPrototypeOf ? Object.setPrototypeOf(n, m) : (n.__proto__ = m, f(n, l, "GeneratorFunction")), n.prototype = Object.create(x), n
                    }, t.awrap = function (n) {
                        return {
                            __await: n
                        }
                    }, _(k.prototype), f(k.prototype, u, (function () {
                        return this
                    })), t.AsyncIterator = k, t.async = function (n, e, r, o, a) {
                        void 0 === a && (a = Promise);
                        var i = new k(d(n, e, r, o), a);
                        return t.isGeneratorFunction(e) ? i : i.next().then((function (n) {
                            return n.done ? n.value : i.next()
                        }))
                    }, _(x), f(x, l, "Generator"), f(x, s, (function () {
                        return this
                        ...
                        abrupt: function (n, t) {
                            ...
                            return i.type = n, i.arg = t, o ? (this.method = "next", this.next = o.finallyLoc, h) : this.complete(i)
                        },
                        complete: function (n, t) {
                            if ("throw" === n.type) throw n.arg;
                            return "break" === n.type || "continue" === n.type ? this.next = n.arg : "return" === n.type ? (this.rval = this.arg = n.arg, this.method = "return", this.next = "end") : "normal" === n.type && t && (this.next = t), h
                        },
                        finish: function (n) {
                            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                                var e = this.tryEntries[t];
                                if (e.finallyLoc === n) return this.complete(e.completion, e.afterLoc), j(e), h
                            }
                        },
                        catch: function (n) {
                            for (var t = this.tryEntries.length - 1; t >= 0; --t) {
    ...
    e.n = n => {
        ...
        var f = function (t) {
            ...
            function s(n, e) {
                var r, s;
                return void 0 === e && (e = {}), (r = t.call(this) || this).nn = {}, r.tn = 0, r.rn = new o, r.en = new o, r.on = new o, r.un = 0, r.an = new Set, r.cn = function () {
                    var n = r.fn,
                        t = n.installing;
                    r.tn > 0 || !a(t.scriptURL, r.sn.toString()) || performance.now() > r.un + 6e4 ? (r.vn = t, n.removeEventListener("updatefound", r.cn)) : (r.hn = t, r.an.add(t), r.rn.resolve(t)), ++r.tn, t.addEventListener("statechange", r.ln)
                }, r.ln = function (n) {
                    var t = r.fn,
                        e = n.target,
                        o = e.state,
                    ...
                    !a && r.mn && (c.isUpdate = !0), r.dispatchEvent(new i(o, c)), "installed" === o ? r.wn = self.setTimeout((function () {
                        "installed" === o && t.waiting === e && r.dispatchEvent(new i("waiting", c))
                    }), 200) : "activating" === o && (clearTimeout(r.wn), a || r.en.resolve(e))
                }, r.dn = function (n) {
                    var t = r.hn,
                    ...
                    return c(r.getSW(), (function () {
                        r.an.has(o) && r.dispatchEvent(new i("message", {
                            data: t,
                            originalEvent: n,
                            ports: e,
                            sw: o
                ...
                }), r.sn = n, r.nn = e, navigator.serviceWorker.addEventListener("message", r.gn), r
            }
            ...
            return d.register = function (n) {
                ...
                try {
                    ...
                    return function (n, t) {
                        ...
                        return r.mn = Boolean(navigator.serviceWorker.controller), r.yn = r.pn(), c(r.bn(), (function (n) {
                            r.fn = n, r.yn && (r.hn = r.yn, r.en.resolve(r.yn), r.on.resolve(r.yn), r.yn.addEventListener("statechange", r.ln, {
                                once: !0
                            }));
                            var t = r.fn.waiting;
                            return t && a(t.scriptURL, r.sn.toString()) && (r.hn = t, Promise.resolve().then((function () {
                ...
                try {
                    ...
                    return function (n, t) {
                        ...
                        return c(navigator.serviceWorker.register(n.sn, n.nn), (function (t) {
            ...
            return t.addEventListener = function (n, t) {
                ...
                n.target = this;
                for (var t, e = r(this.Sn(n.type)); !(t = e()).done;)(0, t.value)(n)
            }, t.Sn = function (n) {
        ...
        function p(n, t, e) {
            return t && d(n.prototype, t), e && d(n, e), Object.defineProperty(n, "prototype", {
                writable: !1
            }), n
        }
        ...
        let L = {
            ...
            set: (n, t, e) => (n[t] = e, !0),
            has: (n, t) => n instanceof IDBTransaction && ("done" === t || "store" === t) || t in n
        };

        function j(n) {
            return "function" == typeof n ? (t = n) !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (b || (b = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function (...n) {
                ...
                const t = new Promise(((t, e) => {
                    const r = () => {
                        ...
                        a = () => {
                            e(n.error || new DOMException("AbortError", "AbortError")), r()
                        };
                    n.addEventListener("complete", o), n.addEventListener("error", a), n.addEventListener("abort", a)
                }));
                x.set(n, t)
            }(n), e = n, (y || (y = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])).some((n => e instanceof n)) ? new Proxy(n, L) : n);
            var t, e
        }
        ...
        function O(n, t, {
            ...
            const i = indexedDB.open(n, t),
                c = I(i);
            return r && i.addEventListener("upgradeneeded", (n => {
                r(I(i.result), n.oldVersion, n.newVersion, I(i.transaction))
            })), e && i.addEventListener("blocked", (() => e())), c.then((n => {
                a && n.addEventListener("close", (() => a())), o && n.addEventListener("versionchange", (() => o()))
            })).catch((() => {})), c
        }
        ...
        function B(n, t) {
            if (!(n instanceof IDBDatabase) || t in n || "string" != typeof t) return;
            if (D.get(t)) return D.get(t);
            const e = t.replace(/FromIndex$/, ""),
                r = t !== e,
                o = T.includes(e);
            if (!(e in (r ? IDBIndex : IDBObjectStore).prototype) || !o && !M.includes(e)) return;
            const a = async function (n, ...t) {
                const a = this.transaction(n, o ? "readwrite" : "readonly");
                let i = a.store;
                return r && (i = i.index(t.shift())), (await Promise.all([i[e](...t), o && a.done]))[0]
            };
            return D.set(t, a), a
        }
        var C;
        ...
        var N = function () {
                var n = v(m().mark((function n() {
                    return m().wrap((function (n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return n.abrupt("return", O("jate", 1, {
                                    upgrade: function (n) {
                                        n.objectStoreNames.contains("jate") ? console.log("jate database already exists") : (n.createObjectStore("jate", {
                                            keyPath: "id",
                                            autoIncrement: !0
            ...
            W = function () {
                var n = v(m().mark((function n(t) {
                    var e, r, o, a, i;
                    return m().wrap((function (n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return console.log("put to the database"), n.next = 3, O("jate", 1);
                            case 3:
                                return e = n.sent, r = e.transaction("jate", "readwrite"), o = r.objectStore("jate"), a = o.put({
                                    id: 1,
                                    value: t
                                }), n.next = 9, a;
                            case 9:
                                i = n.sent, console.log("data saved to database", i.value);
                            case 11:
                            case "end":
                                return n.stop()
                        }
            ...
            A = function () {
                var n = v(m().mark((function n() {
                    ...
                    return m().wrap((function (n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return console.log("get from database"), n.next = 3, O("jate", 1);
                            case 3:
                                return t = n.sent, e = t.transaction("jate", "readonly"), r = e.objectStore("jate"), o = r.put({
                                    id: 1,
                                    value: content
                                }), n.next = 9, o;
                            case 9:
                                (a = n.sent) ? console.log("data retreived form database", a.value): console.log("data not found in database");
                            case 11:
                            case "end":
                                return n.stop()
                        }
        ...
        console.error("getDb not implemented"), N();
        var R = p((function n() {
                var t = this;
                ! function (n, t) {
                ...
                if ("undefined" == typeof CodeMirror) throw new Error("CodeMirror is not loaded");
                this.editor = CodeMirror(document.querySelector("#main"), {
                    ...
                    console.info("Loaded data from IndexedDB, injecting into editor"), t.editor.setValue(n || e || "\n/*\n       _____  ____________\n      / /   |/_  __/ ____/\n __  / / /| | / / / __/   \n/ /_/ / ___ |/ / / /___   \n ____/_/  |_/_/ /_____/   \njust another text editor\n*/                          \n")
                })), this.editor.on("change", (function () {
                    localStorage.setItem("content", t.editor.getValue())
                })), this.editor.on("blur", (function () {
                    console.log("The editor has lost focus"), W(localStorage.getItem("content"))
                }))
            })),
            U = e(379),
            F = e.n(U),
            ...
            Q = e(402),
            X = {};
        X.styleTagTransform = J(), X.setAttributes = K(), X.insert = H().bind(null, "head"), X.domAPI = z(), X.insertStyleElement = Y(), F()(Q.Z, X), Q.Z && Q.Z.locals && Q.Z.locals;
        var nn, tn = document.querySelector("#main");
        tn.innerHTML = "", void 0 === new R && ((nn = document.createElement("div")).classList.add("spinner"), nn.innerHTML = '\n  <div class="loading-container">\n  <div class="loading-spinner" />\n  </div>\n  ', tn.appendChild(nn)), "serviceWorker" in navigator ? new f("/src-sw.js").register() : console.error("Service workers are not supported in this browser.")
    })()
})();